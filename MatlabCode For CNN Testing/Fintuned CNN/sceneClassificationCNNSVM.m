...
% create our net
caffe.set_mode_gpu();
model = './places365-master/deploy_alexnet_scene16.prototxt';
weights = 'alexnet_scene16.caffemodel';
net = caffe.Net(model, weights, 'test')

% get our image mean
image_mean = caffe.io.read_mean('./places365-master/scene16_mean.binaryproto');
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% DATA EXTRACTION %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% - Use matlab com mand imageSet and 'recursive' parameters to to obtain a
% list of folders and all images in them for easy processing
imset = imageSet('C:\DataSets\SCENE DATA\3500ImagesDataset', 'recursive'); %%  %%./SceneDataset
% yields --> 
%imset =
